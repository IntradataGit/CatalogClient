...
* [Major concepts](#major-concepts-)
  ...
  * [Connecting to Digital Catalog](#connecting-to-digital-catalog-)


* [Basic operations](#basic-operations-)
  * [List supported elements](#list-supported-elements-)
  * [List supported document classes](#list-supported-document-classes-)
  * [List supported document categories ](#list-supported-document-categories-)
  * [Get document retention plans](#get-document-retention-plans-)


* [Working with documents](#working-with-documents-)
    * [Adding new document](#adding-new-document-)
    * [Read document's content](#read-documents-content-)
    * [Read document's metadata](#read-documents-metadata-)
    * [Create document's version](#create-documents-version-)
    * [List document's versions](#list-documents-version-)
    * [Remove document version](#remove-document-version-)
    * [Update document's metadata](#update-documents-metadata-)
...
* [Document queries](#document-queries-)
    * [Find documents by text](#find-documents-by-text-)
    * [Get query result metadata](#get-query-result-metadata-)
    * [Get all rows](#get-all-rows-)
    * [Get specific row](#get-specific-row-)
    * [Get specific rows](#get-specific-rows-)
    * [Changing sort order](#chaning-sort-order-)
    * [Using custom query](#using-custom-query-)


* [Entities](#entities-)
    * [List available entities](#list-available-entities-)
    * [Searching for entities](#search-for-entities-)


* [Views](#views-)
    * [List available views](#list-available-views-)
    * [Find documents using views](#find-documents-using-views-)
